			...
			<div class="w3-display-container" style="height: 50px;">
				...
				<div class="w3-display-right">
					<div class="w3-text-blue">	
						<a href="PriceControllerServlet?command=LOAD-PRICE&priceId=${THE_PRICE.id}&theLocale=en_US">Polski (PL)</a> | 
						<a href="PriceControllerServlet?command=LOAD-PRICE&priceId=${THE_PRICE.id}&theLocale=pl_PL">English (US)</a>
					</div>
				</div>
			</div>
		</div>
