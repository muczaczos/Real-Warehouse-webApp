...
<body>
	<a href="update-document-form.jsp?command=LOAD-DOCUMENT&documentId=${THE_DOCUMENT.id}&theLocale=en_US">Polski (PL)</a>
	|
	<a href="update-document-form.jsp?command=LOAD-DOCUMENT&documentId=${THE_DOCUMENT.id}&theLocale=pl_PL">English (US)</a>
