...
<html>
	...
	<body>
		...
		<header class="w3-container w3-green w3-center w3-margin-bottom " style="padding: 75px 16px; background-image: url(images/tektura.jpg)">
			...
			<h1>	<fmt:message key="label.title.update-warehouse" />	</h1>
			...
			<div class="w3-display-container" style="height: 50px;">
				...
				<div class="w3-display-right">
					<div class="w3-text-blue">	
						<a href="WarehouseControllerServlet?command=LOAD-WAREHOUSE&warehouseId=${THE_WAREHOUSE.id}&theLocale=en_US">Polski (PL)</a> |
						<a href="WarehouseControllerServlet?command=LOAD-WAREHOUSE&warehouseId=${THE_WAREHOUSE.id}&theLocale=pl_PL">English (US)</a>
					</div>
				</div>
			</div>
		</div>
						...
						<tbody>
							<tr>
								<td>
									...
									<input class="w3-input" type="text" name="name" value="${THE_WAREHOUSE.name}" />
								</td>
							</tr>
		...
		<hr>
	 	...
	 	<div class="w3-text-blue w3-margin">
			<a href="WarehouseControllerServlet"><fmt:message key="label.back.warehouse" /></a>
		</div>
