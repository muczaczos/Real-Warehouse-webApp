...
<html>
	...
	<body>
			...
			<div class="w3-display-container" style="height: 50px;">
				...
				<div class="w3-display-right">
					<div class="w3-text-blue">
						<a href="Document2ControllerServlet?command=LOAD-DOCUMENT2&doc2Id=${THE_DOCUMENT2.id}&theLocale=en_US">Polski (PL)</a> |
						<a href="Document2ControllerServlet?command=LOAD-DOCUMENT2&doc2Id=${THE_DOCUMENT2.id}&theLocale=pl_PL">English (US)</a>
					</div>
				</div>
		...
		<div class="w3-panel w3-gray w3-padding-16 w3-half">
			...
			<table>
				<tbody>
					<tr>
						<td>
							<label class="w3-text-black" for="datepicker1"><b><fmt:message key="label.date" /></b></label>
							<input class="w3-input" type="text" name="date" value="${THE_DOCUMENT2.date}" id="datepicker1">
						</td>
					</tr>
					<tr>
						<td>
							<label class="w3-text-black"><b><fmt:message key="label.noOfDoc" /></b> </label>
							<input class="w3-input" type="text" name="documentNumber" value="${THE_DOCUMENT2.documentNumber}" />
						</td>
					</tr>

					<tr>
						<td>
							<label class="w3-text-black"><b><fmt:message key="label.provider" /></b></label>
							<input class="w3-input" type="text" name="provider" value="${THE_DOCUMENT2.provider}">
						</td>
					</tr>
					...
					<tr>
						<td>
							...
							<input class="w3-input" type="text" name="product1" value="${THE_DOCUMENT2.product1}">
						</td>
						<td>
							<label class="w3-text-black"><b><fmt:message key="label.qty" /></b></label>
							<input class="w3-input" type="text" name="qty1"  value="${THE_DOCUMENT2.qty1}">
						</td>
					</tr>

					<tr>
						<td>
							<input class="w3-input" type="text" name="product2" value="${THE_DOCUMENT2.product2}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty2" value="${THE_DOCUMENT2.qty2}"/>
						</td>
					</tr>

					<tr>
						<td>
						 	<input class="w3-input" type="text" name="product3" value="${THE_DOCUMENT2.product3}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty3" value="${THE_DOCUMENT2.qty3}" />
						</td>
					</tr>

					<tr>
						<td>
							<input class="w3-input" type="text" name="product4" value="${THE_DOCUMENT2.product4}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty4" value="${THE_DOCUMENT2.qty4}"/>
						</td>
					</tr>

					<tr>
						<td>
							<input class="w3-input" type="text" name="product5" value="${THE_DOCUMENT2.product5}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty5" value="${THE_DOCUMENT2.qty5}" />
						</td>
					</tr>
					<tr>
						<td>
							<input class="w3-input" type="text" name="product6" value="${THE_DOCUMENT2.product6}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty6" value="${THE_DOCUMENT2.qty6}" />
						</td>
					</tr>
					<tr>
						<td>
							<input class="w3-input" type="text" name="product7" value="${THE_DOCUMENT2.product7}">
						</td>
						<td>
							<input class="w3-input" type="text" name="qty7" value="${THE_DOCUMENT2.qty7}"/>
						</td>
					</tr>
					<tr>
						<td>
