...
<html>
	...
	<body>
		...
		<header class="w3-container w3-green w3-center w3-margin-bottom " style="padding: 75px 16px; background-image: url(images/tektura.jpg)">
			...
			<h1>	<fmt:message key="label.title.update-provider" />	</h1>
			...
			<div class="w3-display-container" style="height: 50px;">
				...
				<div class="w3-display-right">
					<div class="w3-text-blue">
						<a href="ProviderControllerServlet?command=LOAD-PROVIDER&providerId=${THE_PROVIDER.id}&theLocale=en_US">Polski (PL)</a> |
						<a href="ProviderControllerServlet?command=LOAD-PROVIDER&providerId=${THE_PROVIDER.id}&theLocale=pl_PL">English (US)</a>
					</div>
				</div>
		...
		<div class="w3-text-blue w3-margin">
			<a href="ProviderControllerServlet"><fmt:message key="label.back.provider" /></a>
		</div>
