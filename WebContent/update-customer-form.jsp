...
<html>
	...
	<body>
		...
		<header class="w3-container w3-green w3-center w3-margin-bottom " style="padding: 75px 16px; background-image: url(images/tektura.jpg)">
			...
			<h1>	<fmt:message key="label.title.update-customer" />	</h1>
			...
			<div class="w3-display-container" style="height: 50px;">
				...
				<div class="w3-display-right">
					<div class="w3-text-blue">
							<a href="CustomerControllerServlet?command=LOAD-CUSTOMER&customerId=${THE_CUSTOMER.id}&theLocale=en_US">Polski (PL)</a> |
							<a href="CustomerControllerServlet?command=LOAD-CUSTOMER&customerId=${THE_CUSTOMER.id}&theLocale=pl_PL">English (US)</a>
					</div>
				</div>
							...
							<tbody>
								<tr>
									<td>
										...
										<input class="w3-input" type="text" name="name" value="${THE_CUSTOMER.name}" />
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<input class="w3-input" type="text" name="address" value="${THE_CUSTOMER.address}" />
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<input class="w3-input" type="text" name="telephone" value="${THE_CUSTOMER.telephone}" />
									</td>
								</tr>
