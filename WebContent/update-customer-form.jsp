...
<body>
	<a href="update-customer-form.jsp?command=LOAD-CUSTOMER&customerId=${THE_CUSTOMER.id}&theLocale=en_US">Polski (PL)</a>
	|
	<a href="update-customer-form.jsp?command=LOAD-CUSTOMER&customerId=${THE_CUSTOMER.id}&theLocale=pl_PL">English (US)</a>
